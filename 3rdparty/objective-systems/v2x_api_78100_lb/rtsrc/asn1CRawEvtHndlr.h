 ...
 * </LI>
 * <LI>ASN1RER_STOP_PARSE: indicates the parser should stop parsing and not
 * consume anymore data.  The parse function will log and return error
 * RTERR_ABORT_REQUESTED.
 * </UL>
 */
typedef enum ASN1RawEventResp
   { ASN1RER_CONSUMED, ASN1RER_PARSE, ASN1RER_QUIET_PARSE, ASN1RER_STOP_PARSE }
   ASN1RawEventResp;
