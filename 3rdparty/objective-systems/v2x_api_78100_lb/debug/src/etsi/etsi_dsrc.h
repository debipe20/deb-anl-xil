...
extern const char* asn1BitNames_ETSI_DSRC_GNSSstatus[];
extern const OSUINT32 asn1BitPositions_ETSI_DSRC_GNSSstatus[];
...
EXTERN ASN1T_ETSI_DSRC_RTCMmessageList* 
   new_ASN1T_ETSI_DSRC_RTCMmessageList (ASN1CType& ccobj);
...
EXTERN ASN1T_ETSI_DSRC_RTCMcorrections_regional* 
   new_ASN1T_ETSI_DSRC_RTCMcorrections_regional (ASN1CType& ccobj);
