...
class DataManager:
    ...
    def generate_plots(self):
        ...
        # self.plot_manager.plot_primary_yaxis(self.experimental_time_data, self.speed_data_mph, "Time [s]", "Speed [mph]", "Time vs Speed Plot", "decel-limit-40_mph_time_vs_speed")
        # self.plot_manager.plot_primary_secondary_yaxis(False, self.experimental_time_data, self.speed_data_mph, self.accel_data_rqst, "Time [s]", "Speed [mph]", "Acceleration [m/s²]", "Time vs Speed and Acceleration Plot", "decel-limit-40_mph_time_vs_speed_Accel")      
        self.plot_manager.plot_primary_secondary_yaxis(True, self.experimental_time_data, self.speed_data_mph, self.accel_data_rqst, "Time [s]", "Speed [mph]", "Acceleration [m/s²]", "Time vs Speed and Acceleration Plot", "decel-limit-40_mph_time_vs_speed_Accel_resize")      
        
        # self.plot_manager.plot_primary_secondary_yaxis(False, self.experimental_time_data, self.speed_data_mph, self.accel_achv, "Time [s]", "Speed [mph]", "Acceleration [m/s²]", "Time vs Speed and Acceleration Plot", "decel-limit-40_mph_time_vs_speed_Accel_achv")
        # self.plot_manager.plot_two_data_on_secondary_yaxis(self.experimental_time_data, self.speed_data_mph, self.accel_data_rqst, self.accel_achv, "Time [s]", "Speed [mph]", "Acceleration [m/s²]",  "Time vs Speed and Acceleration Plot", "decel-limit-40_mph_time_vs_speed_Accel_rqst_achv")
        # specific_accelerations = [0.25, -0.25]
        # self.plot_manager.plot_specific_accelerations(self.experimental_time_data, self.speed_data_mph, self.accel_data_rqst, specific_accelerations, "Time [s]", "Speed [mph]", "Acceleration [m/s²]", "Time vs Speed and Acceleration Plot", "decel-limit-40_mph_time_vs_speed_Accel")
'''##############################################
                   Unit testing
##############################################'''
