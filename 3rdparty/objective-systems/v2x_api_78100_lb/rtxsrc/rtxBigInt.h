 ...
 *               Must have been initialized using rtxBigIntInit.
...
/**
 * Return the number of radix digits that may be required to represent
 * an integer having n base 2 digits (assuming the base 2 number is unsigned).
 * This may return a larger value than the actual value.
 * @param radix 8, 10, or 16
 * @param n Number of base 2 digits; n > 0.
 */
EXTERN OSSIZE rtxBase2DigitsToRadix(OSUINT8 radix, OSSIZE n);


/**
 * Return the number of base 2 digits that may be required to represent
 * an integer having n radix digits (assuming the base 2 number is unsigned).
 * This may return a larger value than the actual value.
 * @param radix 8, 10, or 16
 */
...
/**
 * For internal use only.  The name is misleading.
 * Documentation is in the .c file.
 * Consider instead rtxRadixDigitsToBase2.
 */
