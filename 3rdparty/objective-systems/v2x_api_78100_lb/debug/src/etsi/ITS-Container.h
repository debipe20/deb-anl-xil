...
ItsPduHeader ::= SEQUENCE {
   protocolVersion [0] INTEGER (0..255),
   messageID [1] INTEGER { denm(1), cam(2), poi(3), spatem(4), mapem(5), ivim(6), ev-rsr(7), tistpgtransaction(8), srem(9), ssem(10), evcsn(11), saem(12), rtcmem(13) } (0..255), -- Mantis #7209, #7005
   stationID [2] StationID
}
*/
struct EXTERN ASN1T_ITS_ItsPduHeader {
   OSUINT8 protocolVersion;
...
extern const char* asn1BitNames_ITS_AccelerationControl[];
extern const OSUINT32 asn1BitPositions_ITS_AccelerationControl[];
...
struct EXTERN ASN1T_ITS_CenDsrcTollingZone {
   struct {
      OSUINT8 cenDsrcTollingZoneIDPresent : 1;
   } m;
...
EXTERN void asn1Free_ITS_CenDsrcTollingZone (OSCTXT *pctxt, 
   ASN1T_ITS_CenDsrcTollingZone* pvalue);
...
#define ASN1T_ITS_ProtectedZoneType_ENUMTABSIZE 2
...
struct EXTERN ASN1T_ITS_ProtectedCommunicationZone {
   struct {
      OSUINT8 expiryTimePresent : 1;
      OSUINT8 protectedZoneRadiusPresent : 1;
      OSUINT8 protectedZoneIDPresent : 1;
   } m;
...
EXTERN void asn1Free_ITS_ProtectedCommunicationZone (OSCTXT *pctxt, 
   ASN1T_ITS_ProtectedCommunicationZone* pvalue);
...
EXTERN ASN1T_ITS_ProtectedCommunicationZonesRSU* 
   new_ASN1T_ITS_ProtectedCommunicationZonesRSU (ASN1CType& ccobj);
...
extern const char* asn1BitNames_ITS_ExteriorLights[];
extern const OSUINT32 asn1BitPositions_ITS_ExteriorLights[];
...
struct EXTERN ASN1T_ITS_PathPoint {
   struct {
      OSUINT8 pathDeltaTimePresent : 1;
   } m;
...
EXTERN ASN1T_ITS_PathHistory* new_ASN1T_ITS_PathHistory (ASN1CType& ccobj);
...
extern const char* asn1BitNames_ITS_SpecialTransportType[];
extern const OSUINT32 asn1BitPositions_ITS_SpecialTransportType[];
...
extern const char* asn1BitNames_ITS_LightBarSirenInUse[];
extern const OSUINT32 asn1BitPositions_ITS_LightBarSirenInUse[];
...
*/
typedef ASN1TBitStr32 ASN1T_ITS_DrivingLaneStatus;
...
EXTERN int asn1PE_ITS_DrivingLaneStatus (OSCTXT* pctxt, ASN1T_ITS_DrivingLaneStatus value);
...
ClosedLanes ::= SEQUENCE {
   innerhardShoulderStatus [0] HardShoulderStatus OPTIONAL,
   outerhardShoulderStatus [1] HardShoulderStatus OPTIONAL,
   drivingLaneStatus [2] DrivingLaneStatus OPTIONAL,
   ...
}
*/
struct EXTERN ASN1T_ITS_ClosedLanes {
   struct {
      OSUINT8 innerhardShoulderStatusPresent : 1;
      OSUINT8 outerhardShoulderStatusPresent : 1;
      OSUINT8 drivingLaneStatusPresent : 1;
   } m;
   ASN1T_ITS_HardShoulderStatus innerhardShoulderStatus;
   ASN1T_ITS_HardShoulderStatus outerhardShoulderStatus;
...
EXTERN int asn1Init_ITS_CauseCode (ASN1T_ITS_CauseCode* pvalue, 
   OSBOOL free = FALSE, OSCTXT *pctxt = 0);

EXTERN void asn1Free_ITS_CauseCode (OSCTXT *pctxt, ASN1T_ITS_CauseCode* pvalue);
...
extern const char* asn1BitNames_ITS_EmergencyPriority[];
extern const OSUINT32 asn1BitPositions_ITS_EmergencyPriority[];
...
struct EXTERN ASN1T_ITS_EventPoint {
   struct {
      OSUINT8 eventDeltaTimePresent : 1;
   } m;
...
EXTERN ASN1T_ITS_EventHistory* new_ASN1T_ITS_EventHistory (ASN1CType& ccobj);
...
EXTERN ASN1T_ITS_Traces* new_ASN1T_ITS_Traces (ASN1CType& ccobj);
...
EXTERN ASN1T_ITS_PositionOfPillars* 
   new_ASN1T_ITS_PositionOfPillars (ASN1CType& ccobj);
...
extern const char* asn1BitNames_ITS_PositionOfOccupants[];
extern const OSUINT32 asn1BitPositions_ITS_PositionOfOccupants[];
...
EXTERN ASN1T_ITS_RestrictedTypes* 
   new_ASN1T_ITS_RestrictedTypes (ASN1CType& ccobj);
...
EXTERN ASN1T_ITS_ItineraryPath* new_ASN1T_ITS_ItineraryPath (ASN1CType& ccobj)
   ;
...
*/
typedef const char* ASN1T_ITS_PhoneNumber;

EXTERN int asn1PE_ITS_PhoneNumber (OSCTXT* pctxt, ASN1T_ITS_PhoneNumber value);

EXTERN int asn1PD_ITS_PhoneNumber (OSCTXT* pctxt, ASN1T_ITS_PhoneNumber* pvalue);

EXTERN int XmlEnc_ITS_PhoneNumber (OSCTXT* pctxt, ASN1T_ITS_PhoneNumber value, 
   const OSUTF8CHAR* elemName, const OSUTF8CHAR* nsPrefix);

EXTERN int XmlDec_ITS_PhoneNumber (OSCTXT* pctxt, ASN1T_ITS_PhoneNumber* pvalue
   );

EXTERN int asn1JsonEnc_ITS_PhoneNumber (OSCTXT *pctxt, ASN1T_ITS_PhoneNumber value);

EXTERN int asn1JsonDec_ITS_PhoneNumber (OSCTXT *pctxt, ASN1T_ITS_PhoneNumber *pvalue);

EXTERN int asn1PrtToStrm_ITS_PhoneNumber (OSCTXT *pctxt, 
   const char* name, const ASN1T_ITS_PhoneNumber pvalue);

EXTERN void asn1Free_ITS_PhoneNumber (OSCTXT *pctxt, ASN1T_ITS_PhoneNumber pvalue);
...
DangerousGoodsExtended ::= SEQUENCE {
   ...
   phoneNumber [6] PhoneNumber OPTIONAL,
...
struct EXTERN ASN1T_ITS_DangerousGoodsExtended {
   struct {
      OSUINT8 emergencyActionCodePresent : 1;
      OSUINT8 phoneNumberPresent : 1;
      OSUINT8 companyNamePresent : 1;
   } m;
   ...
   ASN1T_ITS_PhoneNumber phoneNumber;
...
struct EXTERN ASN1T_ITS_VehicleIdentification {
   struct {
      OSUINT8 wMInumberPresent : 1;
      OSUINT8 vDSPresent : 1;
   } m;
...
extern const char* asn1BitNames_ITS_EnergyStorageType[];
extern const OSUINT32 asn1BitPositions_ITS_EnergyStorageType[];
...
*/
typedef const OSUTF8CHAR* ASN1T_ITS_OpeningDaysHours;

class EXTERN ASN1C_ITS_OpeningDaysHours :
public ASN1CType
{
protected:
   ASN1T_ITS_OpeningDaysHours& msgData;
public:
   /**
    * Control class: ASN1C_ITS_OpeningDaysHours
    * Data class:    ASN1T_ITS_OpeningDaysHours
    *
    * Constructs an instance of the control class given an instance of
    * the data class.
    *
    ...
    * @param data    A reference to an instance of the data class.
    */
   ASN1C_ITS_OpeningDaysHours (ASN1T_ITS_OpeningDaysHours& data);

   /**
    * Control class: ASN1C_ITS_OpeningDaysHours<br/>
    * Data class: ASN1T_ITS_OpeningDaysHours<br/>
    *
    * Constructs an instance of the control class given an instance
    * of an encode or decode buffer and an instance of
    * the data class.
    ...
    * @param data   Reference to an instance of the data class.
    */
   ASN1C_ITS_OpeningDaysHours (OSRTMessageBufferIF& msgBuf
      , ASN1T_ITS_OpeningDaysHours& data);

   virtual ~ASN1C_ITS_OpeningDaysHours () {}
    ...
    * Gets a mutable instance of the data class.
    *
    * @return Reference to a mutable instance of data class ASN1T_ITS_OpeningDaysHours.
    */
   inline ASN1T_ITS_OpeningDaysHours& getData () { return msgData; }

   /**
    * Data class: ASN1T_ITS_OpeningDaysHours<br/>
    * Gets a non-mutable instance of the data class.
    *
    * @return Reference to a non-mutable instance of data class ASN1T_ITS_OpeningDaysHours.
    */
   inline const ASN1T_ITS_OpeningDaysHours& getData () const { return msgData; }
    ...
    *
    * @param name A name for the object's contents.  If not specified,
    *             OpeningDaysHours will be used for the name.
    * @return Always returns 0.
    */
   int toStream (const char* name = "OpeningDaysHours");
   /**
    * Declares a print stream handler function.
    *
    * @param strmCallback Pointer to a function defined according to the
   ...
   int setPrintStream (rtxPrintCallback strmCallback, void* pStrmInfo);
private:
   ASN1C_ITS_OpeningDaysHours& operator= (const ASN1C_ITS_OpeningDaysHours&) {return *this;}
} ;

EXTERN int asn1PE_ITS_OpeningDaysHours (OSCTXT* pctxt, ASN1T_ITS_OpeningDaysHours value);

EXTERN int asn1PD_ITS_OpeningDaysHours (OSCTXT* pctxt, ASN1T_ITS_OpeningDaysHours* pvalue);

EXTERN int XmlEnc_ITS_OpeningDaysHours (OSCTXT* pctxt, 
   ASN1T_ITS_OpeningDaysHours value, const OSUTF8CHAR* elemName, 
   const OSUTF8CHAR* nsPrefix);

EXTERN int XmlDec_ITS_OpeningDaysHours (OSCTXT* pctxt, 
   ASN1T_ITS_OpeningDaysHours* pvalue);

EXTERN int asn1JsonEnc_ITS_OpeningDaysHours (OSCTXT *pctxt, ASN1T_ITS_OpeningDaysHours value);

EXTERN int asn1JsonDec_ITS_OpeningDaysHours (OSCTXT *pctxt, ASN1T_ITS_OpeningDaysHours *pvalue);

EXTERN int asn1PrtToStrm_ITS_OpeningDaysHours (OSCTXT *pctxt, 
   const char* name, const ASN1T_ITS_OpeningDaysHours pvalue);

EXTERN void asn1Free_ITS_OpeningDaysHours (OSCTXT *pctxt, 
   ASN1T_ITS_OpeningDaysHours pvalue);
...
*/
/* List of ASN1T_ITS_ReferencePosition */
typedef struct EXTERN ASN1T_ITS_DigitalMap : public ASN1TPDUSeqOfList {
   ~ASN1T_ITS_DigitalMap();
} ASN1T_ITS_DigitalMap;

class EXTERN ASN1C_ITS_DigitalMap :
public ASN1CSeqOfList
{
protected:
   ASN1T_ITS_DigitalMap& msgData;
public:
   /**
    * Control class: ASN1C_ITS_DigitalMap
    * Data class:    ASN1T_ITS_DigitalMap
    *
    * Constructs an instance of the control class given an instance of
    * the data class.
    *
    ...
    * @param data    A reference to an instance of the data class.
    */
   ASN1C_ITS_DigitalMap (ASN1T_ITS_DigitalMap& data);

   /**
    * Control class: ASN1C_ITS_DigitalMap<br/>
    * Data class: ASN1T_ITS_DigitalMap<br/>
    *
    * Constructs an instance of the control class given an instance
    * of an encode or decode buffer and an instance of
    * the data class.
    ...
    * @param data   Reference to an instance of the data class.
    */
   ASN1C_ITS_DigitalMap (OSRTMessageBufferIF& msgBuf
      , ASN1T_ITS_DigitalMap& data);
    ...
    * @param ccobj  Reference to a control class instance.
    * @param data   Reference to an instance of the data class. */
   ASN1C_ITS_DigitalMap (ASN1CType& ccobj, ASN1T_ITS_DigitalMap& data);

   virtual ~ASN1C_ITS_DigitalMap () {}
    ...
    * Gets a mutable instance of the data class.
    *
    * @return Reference to a mutable instance of data class ASN1T_ITS_DigitalMap.
    */
   inline ASN1T_ITS_DigitalMap& getData () { return msgData; }

   /**
    * Data class: ASN1T_ITS_DigitalMap<br/>
    * Gets a non-mutable instance of the data class.
    *
    * @return Reference to a non-mutable instance of data class ASN1T_ITS_DigitalMap.
    */
   inline const ASN1T_ITS_DigitalMap& getData () const { return msgData; }
    ...
    *
    * @param name A name for the object's contents.  If not specified,
    *             DigitalMap will be used for the name.
    * @return Always returns 0.
    */
   int toStream (const char* name = "DigitalMap");
   /**
    * Declares a print stream handler function.
    *
    * @param strmCallback Pointer to a function defined according to the
...
private:
   ASN1C_ITS_DigitalMap& operator= (const ASN1C_ITS_DigitalMap&) {return *this;}
} ;

EXTERN int asn1PE_ITS_DigitalMap (OSCTXT* pctxt, ASN1T_ITS_DigitalMap* pvalue);

EXTERN int asn1PD_ITS_DigitalMap (OSCTXT* pctxt, ASN1T_ITS_DigitalMap* pvalue);

EXTERN int XmlEnc_ITS_DigitalMap (OSCTXT* pctxt, ASN1T_ITS_DigitalMap* pvalue, 
   const OSUTF8CHAR* elemName, const OSUTF8CHAR* nsPrefix);

EXTERN int XmlDec_ITS_DigitalMap (OSCTXT* pctxt, ASN1T_ITS_DigitalMap* pvalue)
   ;

EXTERN int asn1JsonEnc_ITS_DigitalMap (OSCTXT *pctxt, ASN1T_ITS_DigitalMap *pvalue);

EXTERN int asn1JsonDec_ITS_DigitalMap (OSCTXT *pctxt, ASN1T_ITS_DigitalMap *pvalue);

EXTERN int asn1PrtToStrm_ITS_DigitalMap (OSCTXT *pctxt, 
   const char* name, const ASN1T_ITS_DigitalMap* pvalue);

EXTERN ASN1T_ITS_DigitalMap* new_ASN1T_ITS_DigitalMap (ASN1CType& ccobj);

EXTERN int asn1Init_ITS_DigitalMap (ASN1T_ITS_DigitalMap* pvalue, 
   OSBOOL free = FALSE, OSCTXT *pctxt = 0);

EXTERN void asn1Free_ITS_DigitalMap (OSCTXT *pctxt, ASN1T_ITS_DigitalMap* pvalue);
