...
struct EXTERN ASN1T_BasicVehicleContainerHighFrequency {
   struct {
      OSUINT8 accelerationControlPresent : 1;
      OSUINT8 lanePositionPresent : 1;
      OSUINT8 steeringWheelAnglePresent : 1;
      OSUINT8 lateralAccelerationPresent : 1;
      OSUINT8 verticalAccelerationPresent : 1;
      OSUINT8 performanceClassPresent : 1;
      OSUINT8 cenDsrcTollingZonePresent : 1;
   } m;
...
struct EXTERN ASN1T_RSUContainerHighFrequency {
   struct {
      OSUINT8 protectedCommunicationZonesRSUPresent : 1;
   } m;
...
struct EXTERN ASN1T_RoadWorksContainerBasic {
   struct {
      OSUINT8 roadworksSubCauseCodePresent : 1;
...
struct EXTERN ASN1T_EmergencyContainer {
   struct {
      ...
      OSUINT8 emergencyPriorityPresent : 1;
   } m;
   ASN1T_ITS_LightBarSirenInUse lightBarSirenInUse;
...
struct EXTERN ASN1T_CamParameters {
   struct {
      OSUINT8 lowFrequencyContainerPresent : 1;
      OSUINT8 specialVehicleContainerPresent : 1;
   } m;
