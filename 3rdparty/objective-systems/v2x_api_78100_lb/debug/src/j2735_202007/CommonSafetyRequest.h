...
EXTERN ASN1T_RequestedItemList* new_ASN1T_RequestedItemList (ASN1CType& ccobj)
   ;
...
EXTERN ASN1T_CommonSafetyRequest_regional* 
   new_ASN1T_CommonSafetyRequest_regional (ASN1CType& ccobj);
