...
struct EXTERN ASN1T_ManagementContainer {
   struct {
      OSUINT8 terminationPresent : 1;
      OSUINT8 relevanceDistancePresent : 1;
      OSUINT8 relevanceTrafficDirectionPresent : 1;
      OSUINT8 validityDurationPresent : 1;
      OSUINT8 transmissionIntervalPresent : 1;
   } m;
...
struct EXTERN ASN1T_SituationContainer {
   struct {
      OSUINT8 linkedCausePresent : 1;
      OSUINT8 eventHistoryPresent : 1;
   } m;
...
struct EXTERN ASN1T_LocationContainer {
   struct {
      OSUINT8 eventSpeedPresent : 1;
      OSUINT8 eventPositionHeadingPresent : 1;
      OSUINT8 roadTypePresent : 1;
   } m;
...
EXTERN ASN1T_ReferenceDenms* new_ASN1T_ReferenceDenms (ASN1CType& ccobj);
...
struct EXTERN ASN1T_RoadWorksContainerExtended {
   struct {
      OSUINT8 lightBarSirenInUsePresent : 1;
      OSUINT8 closedLanesPresent : 1;
      OSUINT8 restrictionPresent : 1;
      OSUINT8 speedLimitPresent : 1;
      OSUINT8 incidentIndicationPresent : 1;
      OSUINT8 recommendedPathPresent : 1;
      OSUINT8 startingPointSpeedLimitPresent : 1;
      OSUINT8 trafficFlowRulePresent : 1;
      OSUINT8 referenceDenmsPresent : 1;
   } m;
...
struct EXTERN ASN1T_StationaryVehicleContainer {
   struct {
      OSUINT8 stationarySincePresent : 1;
      OSUINT8 stationaryCausePresent : 1;
      OSUINT8 carryingDangerousGoodsPresent : 1;
      OSUINT8 numberOfOccupantsPresent : 1;
      OSUINT8 vehicleIdentificationPresent : 1;
      OSUINT8 energyStorageTypePresent : 1;
   } m;
...
struct EXTERN ASN1T_AlacarteContainer {
   struct {
      OSUINT8 lanePositionPresent : 1;
      OSUINT8 impactReductionPresent : 1;
      OSUINT8 externalTemperaturePresent : 1;
      OSUINT8 roadWorksPresent : 1;
      OSUINT8 positioningSolutionPresent : 1;
      OSUINT8 stationaryVehiclePresent : 1;
   } m;
...
struct EXTERN ASN1T_DecentralizedEnvironmentalNotificationMessage {
   struct {
      OSUINT8 situationPresent : 1;
      OSUINT8 locationPresent : 1;
      OSUINT8 alacartePresent : 1;
   } m;
