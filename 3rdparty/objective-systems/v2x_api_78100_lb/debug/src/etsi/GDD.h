...
extern const char* asn1BitNames_RepeatingPeriodDayTypes[];
extern const OSUINT32 asn1BitPositions_RepeatingPeriodDayTypes[];
...
extern const char* asn1BitNames_DayOfWeek[];
extern const OSUINT32 asn1BitPositions_DayOfWeek[];
...
struct EXTERN ASN1T_InternationalSign_applicablePeriod {
   struct {
      ...
      OSUINT8 repeatingPeriodDayTypesPresent : 1;
      OSUINT8 hourMinutesPresent : 1;
      OSUINT8 dateRangeOfWeekPresent : 1;
      OSUINT8 durationHourMinutePresent : 1;
   } m;
...
struct EXTERN ASN1T_InternationalSign_applicableVehicleDimensions {
   struct {
      OSUINT8 vehicleHeightPresent : 1;
      OSUINT8 vehicleWidthPresent : 1;
      OSUINT8 vehicleLengthPresent : 1;
      OSUINT8 vehicleWeightPresent : 1;
   } m;
...
struct EXTERN ASN1T_InternationalSign_speedLimits {
   struct {
      OSUINT8 speedLimitMaxPresent : 1;
      OSUINT8 speedLimitMinPresent : 1;
   } m;
...
struct EXTERN ASN1T_InternationalSign_section {
   struct {
      OSUINT8 startingPointLengthPresent : 1;
      OSUINT8 continuityLengthPresent : 1;
   } m;
...
EXTERN ASN1T_GddAttributes* new_ASN1T_GddAttributes (ASN1CType& ccobj);
...
struct EXTERN ASN1T_DestinationPlace {
   struct {
      OSUINT8 destRSCodePresent : 1;
      OSUINT8 destBlobPresent : 1;
      OSUINT8 placeNameIdentificationPresent : 1;
      OSUINT8 placeNameTextPresent : 1;
   } m;
...
EXTERN ASN1T_DestinationPlaces* new_ASN1T_DestinationPlaces (ASN1CType& ccobj)
   ;
...
struct EXTERN ASN1T_DestinationRoad {
   struct {
      OSUINT8 roadNumberIdentifierPresent : 1;
      OSUINT8 roadNumberTextPresent : 1;
   } m;
...
EXTERN ASN1T_DestinationRoads* new_ASN1T_DestinationRoads (ASN1CType& ccobj);
...
struct EXTERN ASN1T_DDD_IO {
   struct {
      OSUINT8 destPlacePresent : 1;
      OSUINT8 destRoadPresent : 1;
      OSUINT8 roadNumberIdentifierPresent : 1;
      OSUINT8 streetNamePresent : 1;
      OSUINT8 streetNameTextPresent : 1;
      OSUINT8 distanceToDivergingPointPresent : 1;
      OSUINT8 distanceToDestinationPlacePresent : 1;
   } m;
...
EXTERN ASN1T_DDD_IO_LIST* new_ASN1T_DDD_IO_LIST (ASN1CType& ccobj);
...
struct EXTERN ASN1T_InternationalSign_destinationInformation {
   struct {
      OSUINT8 junctionDirectionPresent : 1;
      OSUINT8 roundaboutCwDirectionPresent : 1;
      OSUINT8 roundaboutCcwDirectionPresent : 1;
   } m;
