...
TransceiverEncoder::TransceiverEncoder()
{
    ...
    string bsmLogFileName = "BSM-Payload.log";
    bsmLogFile.open(bsmLogFileName);
    string spatLogFileName = "SPaT-Payload.log";
    spatLogFile.open(spatLogFileName);
}
...
string TransceiverEncoder::TransceiverEncoder::BSMEncoder(string jsonString)
{
    ...
    loggingBsmData(bsmMessagePayload);
...
string TransceiverEncoder::SPaTEncoder(string jsonString)
{
    ...
    loggingSpatData(spatMessagePayload);
...
void TransceiverEncoder::loggingBsmData(string logString)
{
	bsmLogFile << logString << endl;
}

void TransceiverEncoder::loggingSpatData(string logString)
{
	spatLogFile << logString << endl;
}
