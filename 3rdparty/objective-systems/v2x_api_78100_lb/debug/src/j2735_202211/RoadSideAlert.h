...
EXTERN ASN1T_RoadSideAlert_description* 
   new_ASN1T_RoadSideAlert_description (ASN1CType& ccobj);
...
EXTERN ASN1T_RoadSideAlert_regional* 
   new_ASN1T_RoadSideAlert_regional (ASN1CType& ccobj);
