...
/**
 * This function encodes the JSON representation of an OID value
 * from a dynamic OID structure.
 *
 * @param   pctxt    A pointer to a context data structure.
 * @param   pDynOID  A pointer to an ASN1DynOBJID data structure.
 *
 * @return  0 on success, less than zero otherwise.
 */
EXTERNJSON int rtJsonAsn1EncDynOID (OSCTXT* pctxt, ASN1DynOBJID* pDynOID);
...
/**
 * This function decodes the JSON representation of an OID value into
 ...
 * @return  0 on success, less than zero otherwise.
 */
EXTERNJSON int rtJsonAsn1DecDynOIDValue (OSCTXT* pctxt, ASN1DynOBJID* pDynOID);
