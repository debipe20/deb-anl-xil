...
import os
from panda_preprocessing import split_message_id
...
class Diagnostic:
    ...
    def check_message_start(self):
        ...
        prefix = '0x'
        message_start = self.message_start.replace(' ', '')
        if self.message_start[:2] == prefix:
    ...
    def set_data_path(self, data_path):
        ...
        if not os.path.isfile(self.data_path):
            split_message_id(data_path, self.arbid, self.message_start)
