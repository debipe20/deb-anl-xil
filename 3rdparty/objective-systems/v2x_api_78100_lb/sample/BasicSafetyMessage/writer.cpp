...
int main (int argc, char** argv)
{
   ...
   if (0 != infilename) {
      ...
      // Timestamp and Height added in 11/2022 version of specification...
      vsExtns.m.timestampPresent = 1;
      vsExtns.timestamp.m.yearPresent = 1;
      vsExtns.timestamp.year = 2022;
      vsExtns.timestamp.m.monthPresent = 1;
      vsExtns.timestamp.month = 11;
      vsExtns.timestamp.m.dayPresent = 1;
      vsExtns.timestamp.day = 22;
      vsExtns.timestamp.m.hourPresent = 1;
      vsExtns.timestamp.hour = 12;
      vsExtns.timestamp.m.minutePresent = 1;
      vsExtns.timestamp.minute = 34;
      vsExtns.m.heightPresent = 1;
      vsExtns.height = 100;
