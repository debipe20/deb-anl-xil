...
public:
   enum TVALUE {
      ...
      T_roadSafetyMessage,
      T_roadWeatherMessage,
      T_probeDataConfigMessage,
      T_probeDataReportMessage,
      T_tollAdvertisementMessage,
      T_tollUsageMessage,
      T_tollUsageAckMessage,
      T_cooperativeControlMessage,
      T_sensorDataSharingMessage,
      T_maneuverSharingAndCoordinatingMessage,
      T_roadGeometryAndAttributes,
      T_personalSafetyMessage2,
      T_trafficSignalPhaseAndTiming,
      T_signalControlAndPrioritizationRequest,
      T_signalControlAndPrioritizationStatus,
      T_testMessage00,
      T_testMessage01,
      T_testMessage02,
      T_testMessage03,
...
struct EXTERN ASN1T_MessageFrame : public ASN1TPDU {
   ...
   struct  {
      ...
      union {
         ...
         /**
          * id: roadSafetyMessage
          */
         /**
          * id: roadWeatherMessage
          */
         struct ASN1T_RoadWeatherMessage *_MessageTypes_roadWeatherMessage;
         /**
          * id: probeDataConfigMessage
          */
         ASN1TSeqOfList *_MessageTypes_probeDataConfigMessage;
         /**
          * id: probeDataReportMessage
          */
         struct ASN1T_ProbeDataReportMessage *_MessageTypes_probeDataReportMessage;
         /**
          * id: tollAdvertisementMessage
          */
         /**
          * id: tollUsageMessage
          */
         /**
          * id: tollUsageAckMessage
          */
         /**
          * id: cooperativeControlMessage
          */
         /**
          * id: sensorDataSharingMessage
          */
         /**
          * id: maneuverSharingAndCoordinatingMessage
          */
         /**
          * id: roadGeometryAndAttributes
          */
         /**
          * id: personalSafetyMessage2
          */
         /**
          * id: trafficSignalPhaseAndTiming
          */
         /**
          * id: signalControlAndPrioritizationRequest
          */
         /**
          * id: signalControlAndPrioritizationStatus
          */
         /**
          * id: testMessage00
          */
...
public:
   ...
   void setTC_MessageTypes_roadSafetyMessage();
   void setTC_MessageTypes_roadWeatherMessage(struct ASN1T_RoadWeatherMessage 
      *pvalue);
   void setTC_MessageTypes_probeDataConfigMessage(ASN1TSeqOfList *pvalue);
   void setTC_MessageTypes_probeDataReportMessage(struct 
      ASN1T_ProbeDataReportMessage *pvalue);
   void setTC_MessageTypes_tollAdvertisementMessage();
   void setTC_MessageTypes_tollUsageMessage();
   void setTC_MessageTypes_tollUsageAckMessage();
   void setTC_MessageTypes_cooperativeControlMessage();
   void setTC_MessageTypes_sensorDataSharingMessage();
   void setTC_MessageTypes_maneuverSharingAndCoordinatingMessage();
   void setTC_MessageTypes_roadGeometryAndAttributes();
   void setTC_MessageTypes_personalSafetyMessage2();
   void setTC_MessageTypes_trafficSignalPhaseAndTiming();
   void setTC_MessageTypes_signalControlAndPrioritizationRequest();
   void setTC_MessageTypes_signalControlAndPrioritizationStatus();
...
EXTERN void asn1SetTC_MessageFrame_MessageTypes_roadSafetyMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

struct ASN1T_RoadWeatherMessage ;
EXTERN void asn1SetTC_MessageFrame_MessageTypes_roadWeatherMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem, struct ASN1T_RoadWeatherMessage 
   *pvalue);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_probeDataConfigMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem, ASN1TSeqOfList *pvalue);

struct ASN1T_ProbeDataReportMessage ;
EXTERN void asn1SetTC_MessageFrame_MessageTypes_probeDataReportMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem, struct 
   ASN1T_ProbeDataReportMessage *pvalue);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_tollAdvertisementMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_tollUsageMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_tollUsageAckMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_cooperativeControlMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_sensorDataSharingMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_maneuverSharingAndCoordinatingMessage
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_roadGeometryAndAttributes
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_personalSafetyMessage2
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_trafficSignalPhaseAndTiming
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_signalControlAndPrioritizationRequest
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);

EXTERN void asn1SetTC_MessageFrame_MessageTypes_signalControlAndPrioritizationStatus
   (OSCTXT* pctxt, ASN1T_MessageFrame* pElem);
