...
struct EXTERN ASN1T_VehicleData {
   ...
   OSUINT8 mass;
   ASN1T_PivotPointDescription pivotPoint;
   struct ASN1T_Axles *axles;
   OSINT8 rollAngle;
   OSUINT16 deprecated;
   ASN1TSeqExt extElem1;
   ASN1T_VehicleData ();
...
struct EXTERN ASN1T_SupplementalVehicleExtensions {
   ...
   ASN1T_WeatherReport deprecated1;
   ASN1T_WeatherProbe deprecated2;
   ASN1T_ObstacleDetection deprecated3;
   ASN1T_DisabledVehicle status;
   ASN1T_SpeedProfile deprecated4;
   ASN1T_RTCMPackage deprecated5;
   ASN1T_SupplementalVehicleExtensions_regional regional;
   OSUINT32 fhwaVehicleClass;
   ASN1TSeqOfList trailers;
   ASN1TSeqExt extElem1;
