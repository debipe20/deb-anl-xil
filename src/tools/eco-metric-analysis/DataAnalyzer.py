...
- analyzeDynoLog(): Method to cleaned up the data collected usign VOICES Data Collection system
- getStartAndEndTimeIndex(dataframe): Method to get index for the start time and end time of the diagram
- plotRelativeDistanceAndSpeedProfileIndividually(): Method to plot relative distance and speed profile in a same diagram
- plotRelativeDistanceAndSpeedProfileJointly(): Method to plot relative distance and speed profile as subplot
- plotEgoVehicleSpeedProfile(): Method to plot ego vehicle speed profile for all group run
***************************************************************************************
"""
import pandas as pd
import os
